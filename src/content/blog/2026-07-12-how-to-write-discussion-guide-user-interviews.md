...
category: "Research"
draft: false
heroImageAlt: "A researcher's desk showing a printed discussion guide with handwritten probe notes alongside an open laptop ready for a video user interview"
tags:
  - "user interviews & discussion guides"
...
Leave a margin or column for in-session annotations. Noting where a participant paused, where something unexpected came up, or where a probe worked particularly well takes seconds and pays back considerably during analysis. Read more about that stage in our post on [how to analyze user interview data](https://blog.glasgow.works/blog/how-to-analyze-user-interview-data).
...
Good analysis depends on good data, and good data depends on a guide that was written with care. Once you've run your sessions, our posts on [writing a UX research report that drives action](https://blog.glasgow.works/blog/how-to-write-a-ux-research-report) and [thematic analysis in qualitative research](https://blog.glasgow.works/blog/thematic-analysis-qualitative-research) cover what comes next.
