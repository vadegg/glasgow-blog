...
category: "Research"
draft: false
heroImageAlt: "Bar chart comparing user research costs across DIY, in-house, agency, and AI-tool delivery models by research method"
tags:
  - "Research Operations — budgeting & buying decisions"
  - "user research pricing by method"
  - "cost of UX research"
...
Still weighing whether to build this capability internally or bring in outside help? Our guide on [when to outsource user research to an agency](/blog/when-to-outsource-user-research-agency-vs-in-house) walks through the build-versus-buy decision in more depth.
...
**How much does user research cost on average?**
There isn't one figure — it depends on delivery model and method. DIY studies typically run $0–$800, in-house tool-assisted studies $500–$4,000, and agency-led studies $5,000–$30,000+. Use the quick-answer table above to find your scenario.

**Is DIY user research really free?**
No. There's no invoice, but staff time (often 15–20 hours per study), incentive budgets, and slower speed-to-insight are all real costs — they just don't show up as a line item.

**How much does an agency typically charge for a research study?**
Single-method studies typically run $5,000–$12,000; multi-method programmes run $15,000–$30,000 or more. That usually bundles recruitment, moderation, synthesis, and a stakeholder readout, though scope varies by agency and audience specificity.

**Do AI research tools actually reduce cost without hurting quality?**
They cut moderation and synthesis time and cost, not recruitment spend — you still need real, incentivised participants. They work well for well-scoped, lower-stakes studies and less well for sensitive or highly exploratory topics.

**How should a first-time team budget for user research?**
Start small: one method, one clear research question, 5–8 participants, and a 15–20% contingency for re-recruitment. A first study in the $500–$2,000 range (DIY or AI-tool-assisted) is enough to test the process before you scale spend.
<!-- gr:footer -->
---
