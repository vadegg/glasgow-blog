...
category: "Research"
draft: false
heroImageAlt: "A researcher and a B2B SaaS buyer sitting at a table during a jobs-to-be-done switch interview, with a timeline of decision moments on a whiteboard behind them"
tags:
  - "Jobs-to-Be-Done interviews (B2B SaaS)"
  - "jtbd interviews b2b saas"
  - "switch interview"
...
1. **Push** — the dissatisfaction or pressure in the current situation that makes staying feel untenable.
2. **Pull** — the appeal of the new solution and the imagined better situation it promises.
3. **Anxiety** — the fears and uncertainties that slow or block the switch (implementation risk, contract terms, internal resistance).
4. **Habits** — the inertia of existing tools, processes, and behaviours that make the old situation comfortable despite its problems.
