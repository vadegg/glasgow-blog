...
category: "Research"
draft: false
heroImageAlt: "A researcher mapping the five stages of a Switch Interview on a whiteboard, with colour-coded sticky notes representing the four forces of progress"
tags:
  - "jobs-to-be-done"
...
- **Uncover demand triggers** that your [product discovery research](/blog/product-discovery) has not yet captured
...
| Force | Interview focus |
|---|---|
| Push | First Thought and Passive Looking stages |
| Pull | Active Looking and Decision stages |
| Anxiety | Decision stage — "what almost stopped you?" |
| Habit | Ongoing Use — what they miss or have abandoned |
...
For a wider view of where this method sits, see our overview of [jobs-to-be-done research methods](/blog/product-research).
