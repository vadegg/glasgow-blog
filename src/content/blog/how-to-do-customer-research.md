...
There is also a newer version of the same mistake: teams skip the hard part and ask AI what customers want. That produces fast, polished language and very little grounded evidence. It removes discomfort, not uncertainty. I wrote about that trap more directly in [/blog/synthetic-respondents-ai-research/](/blog/synthetic-respondents-ai-research/).
...
That is one reason [customer research methods](/blog/customer-research-methods/) get chosen so badly. Teams start with the ritual instead of the question. They think the important part is "doing research" at all. It is not. The important part is whether the work can generate decision-grade signal.
...
This is also why customer research quality depends so much on interview quality. If the person running the conversation cannot separate warmth from evidence, the team starts building on top of social comfort. That is one reason weak interviewing is so expensive, and why I wrote [/blog/why-you-shouldnt-delegate-customer-interviews/](/blog/why-you-shouldnt-delegate-customer-interviews/) in the first place.
...
1. Name the decision.
   Do not start with "we need feedback." Start with the real business question.

2. Find the right people.
   Talk to people who genuinely sit close to the problem, not just people who are available or polite.

3. Ask about past behavior and current workarounds.
   Move the conversation away from ideas and toward evidence.

4. Capture what makes the problem matter.
   Look for urgency, cost, delay, friction, and what people already do to cope.

5. Watch what happens after the call.
   Follow-up behavior is part of the research, not a separate sales issue.

6. Treat praise carefully.
   If someone likes the idea but does nothing, record that as weak signal, not traction.

7. Look for patterns, not flattering quotes.
   Your job is not to build a slide deck full of encouraging lines. Your job is to improve the next decision.
