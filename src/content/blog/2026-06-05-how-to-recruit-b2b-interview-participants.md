...
category: "Research"
draft: false
heroImageAlt: "A researcher reviewing a list of B2B interview candidates on a laptop with a CRM dashboard visible in the background"
tags:
  - "recruiting B2B interview participants"
  - "B2B user research recruitment"
  - "recruiting enterprise interview participants"
...
Our [general participant recruitment guide](https://blog.glasgow.works/blog/how-to-recruit-participants-for-user-research) covers the foundations. This post focuses on what changes when the audience is professional and hard to reach.
...
|---|---|---|---|
| Own CRM | Fast | High | Low |
| Warm intros via colleagues | Medium | High | Low |
| LinkedIn (personalised) | Medium | Medium–high | Low–medium |
| Industry communities | Slow | Medium | Low |
| B2B research panels | Medium | Medium | Medium–high |
| Conferences / trade bodies | Slow | Variable | Medium |

---

## Navigating Gatekeepers and Procurement Blockers
...
Once sessions are complete, use [affinity mapping to make sense of what participants tell you](https://blog.glasgow.works/blog/affinity-mapping-in-qualitative-research).
...
For related topics across the product research lifecycle, visit our [B2B product research hub](/blog/product-research).
