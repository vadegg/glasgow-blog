...
Within a broader [UX research methods](/blog/ux-research-methods) toolkit, interviews sit at the exploratory, generative end. Use them to open questions, not to close them.
...
Build time into your plan for synthesis between sessions. Rushing from one interview to the next without a debrief erodes the quality of your analysis. See our thinking on [research cadence and planning](/blog/research-operations) for a fuller treatment.
...
Build purposive variation into your sample. Seek difference in experience level, context of use, and life situation. This is not the same as demographic quotas — it is about ensuring your sample is not accidentally homogeneous in ways that blind you to important variation. More on logistics is covered in our [participant recruitment and panels](/blog/research-operations) guidance.
...
For detailed guidance on synthesis methods and workflows, see our pieces on [synthesis and analysis workflows](/blog/insight-to-impact) and [product discovery](/blog/product-discovery).
