...
category: "Research"
draft: false
heroImageAlt: "A UX researcher observing and taking notes beside a user working at their desk in a real office environment"
tags:
  - "UX Research Methods"
...
For a broader view of where CI fits alongside other approaches, the [UX research methods overview](https://blog.glasgow.works/blog/ux-research-methods) maps the full toolkit.
...
For a direct comparison across evaluation approaches, see [usability testing vs user interviews](https://blog.glasgow.works/blog/usability-testing-vs-user-interviews).
...
- Document the full study structure using a [user research plan template](https://blog.glasgow.works/blog/user-research-plan-template)
...
Findings should be design-actionable insights: "Users need to cross-reference two data states simultaneously during the review step." Not feature requests: "Users want a split-screen view." For a repeatable approach to this translation step, see [how to analyse user interview data](https://blog.glasgow.works/blog/how-to-analyze-user-interview-data) — the synthesis workflow applies equally to CI data.
...
Products and workflows evolve. A CI study conducted at launch provides a baseline; it does not serve indefinitely. Teams that run CI once and never revisit it accumulate [research debt in product teams](https://blog.glasgow.works/blog/research-debt-in-product-teams) — a growing gap between what they know and what is actually true about their users' environment.
