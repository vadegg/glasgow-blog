...
The test for adequate synthesis is simple: can someone who was not in the research sessions read your output and understand what to do differently? If not, the synthesis work is unfinished. For context on when synthesis fits within a broader [product research](/blog/product-research) programme, that post covers the full research lifecycle.
...
Communicating findings is a learned skill that sits within a broader set of research practices. It does not happen automatically as a byproduct of rigorous fieldwork — it requires deliberate design, and it is a core component of [building ResearchOps that scales](/blog/research-operations).
...
If you are building or refining your research practice, the cluster posts linked throughout this guide cover each component in more depth: recruitment is covered in our post on [how to recruit participants for user research](/blog/how-to-recruit-participants-for-user-research), synthesis mechanics are detailed in the affinity mapping post, and the operational infrastructure sits within our ResearchOps content.
