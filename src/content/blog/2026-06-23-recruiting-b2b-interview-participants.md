...
This is operationally different from [generic user research recruitment](https://blog.glasgow.works/blog/how-to-recruit-participants-for-user-research), which can lean on panel reach and demographic filters. B2B recruitment requires relationship context: who referred this person, what their company situation is, and whether they are the right archetype for your study question.
...
Next, map your screener criteria precisely: job title range, company size band (headcount or ARR), industry vertical, relevant tech stack, and deal stage. That last criterion matters more than most teams acknowledge. A study that mixes current happy customers with churned accounts and active prospects is running three different studies at once — unless that mix is deliberate, as it would be in [win-loss analysis studies](https://blog.glasgow.works/blog/win-loss-analysis-b2b-saas).
...
**Churned accounts.** A high-signal segment that most teams ignore. [Churn research workflows](https://blog.glasgow.works/blog/churn-research-for-saas) exist precisely because churned customers hold unfiltered opinions that happy customers will soften. They require a more deliberate approach to reach but are worth the effort.
...
Speaking of which: [document your process in a research plan](https://blog.glasgow.works/blog/user-research-plan-template) before recruitment begins. A written process is the only way to repeat it efficiently on the next study.
...
For the study design underpinning this kind of work, see our notes on [jobs-to-be-done interviews with B2B buyers](https://blog.glasgow.works/blog/how-to-recruit-b2b-interview-participants).
...
**Recruiting as a project phase rather than a background process.** Starting recruitment two weeks before sessions are needed is almost always too late. Embedding it as a [continuous background research process](https://blog.glasgow.works/blog/opportunity-prioritisation-product-research) means a warm pool exists before the next study brief arrives.
