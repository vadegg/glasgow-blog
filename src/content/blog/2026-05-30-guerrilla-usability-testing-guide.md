...
1. **Warm-up** (2–3 minutes): low-stakes questions to settle the participant — their device habits, how they typically use similar products.
2. **Scenario framing:** a short narrative that puts the participant in a realistic context without signposting the solution.
3. **2–3 core tasks:** the direct probes of your hypothesis.
4. **2–3 post-task probes:** open questions after each task — "What would you normally do next?" or "What, if anything, was unclear?"
5. **Closing:** a brief thanks and an open invitation — "Is there anything you noticed that we have not talked about?"
...
Your output should be a one-page findings summary with the top 3 actionable fixes. That format fits directly into sprint planning. For connecting findings to wider research strategy, the [UX research methods hub](/blog/ux-research-methods) provides a useful reference point.
