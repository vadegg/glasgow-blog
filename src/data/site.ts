...
export const SITE = {
  ...
  logoUrl: 'https://blog.glasgow.works/logo.png',
  logoWidth: 412,
  logoHeight: 120,
  linkedinUrl: 'https://www.linkedin.com/company/glasgow-research',
  language: 'English',
  market: 'Global',
  audience: [
    'Founders',
...
export const AUTHORS = {
  vadim: {
    ...
    linkedinUrl: 'https://www.linkedin.com/in/vadim-glazkov/',
    selectedExperience: [
